...
"""
2. Get instrument token of near month index future, here it is NIFTY
...
"""
5. download price, evaluate the logic and place order
"""
        ...
        if signal == 'BUY' or signal == 'SELL':
            try:
                    orderid = kite.place_order(exchange='NFO',
                                                ...
                                                quantity=int(50), # set the quantity in numptiple of lot sizes
                                                #price=LTP,
                                                product='NRML',
